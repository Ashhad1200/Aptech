...
$sql="SELECT COUNT(*) as tu FROM `admin_register`";
...
// include('pages/samples/conn.php');
$sql1="SELECT * FROM `admin_register` ORDER BY `a_id` DESC LIMIT 1";
...
?>
                      <tbody>
                        <tr>
                          ...
                          <td class="font-weight-bold"><?php echo $row1[2]  ?></td>
                          <td><?php echo $row1[3]  ?></td>
                          <td class="font-weight-medium">
                            <div class="badge badge-success"><?php echo $row1[4]  ?></div>
                          </td>
                        </tr>
